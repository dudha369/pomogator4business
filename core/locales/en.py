EN = {
    ...
    "cmddesc.story": "Splits a photo and posts it as Stories",
    "cmddesc.storysplit": "Just splits a photo into pieces — without posting to Stories",
    "cmddesc.spam": "Sends several identical messages in a row (limit without a mirror bot — 100)",
    "cmddesc.storyautopost": "Toggles posting one tile per day instead of all at once",
