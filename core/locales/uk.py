UK = {
    ...
    "cmddesc.storysplit": "Просто розрізає фото на частини — без публікації в Історії",
    "cmddesc.spam": "Надсилає кілька однакових повідомлень підряд (ліміт без дзеркала — 100)",
    "cmddesc.storyautopost": "Перемикає публікацію по одному тайлу в день замість одразу всіх",
