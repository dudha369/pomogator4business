...
QUESTIONS = [
    ...
    ("В каком году человек впервые полетел в космос?", ["1957", "1961", "1969", "1965"], 1),
    ("Сколько цветов в радуге?", ["5", "6", "7", "8"], 2),
    ("Самый большой океан на Земле?", ["Атлантический", "Индийский", "Северный Ледовитый", "Тихий"], 3),
    ("Какой газ преобладает в атмосфере Земли?", ["Кислород", "Азот", "Углекислый газ", "Водород"], 1),
    ("Автор картины \"Мона Лиза\"?", ["Рафаэль", "Микеланджело", "да Винчи", "Донателло"], 2),
    ("Столица Японии?", ["Осака", "Киото", "Токио", "Иокогама"], 2),
    ("Сколько дней в високосном году?", ["364", "365", "366", "367"], 2),
    ("Самое большое млекопитающее?", ["Слон", "Синий кит", "Жираф", "Белый медведь"], 1),
